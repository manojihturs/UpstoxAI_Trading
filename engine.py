...
# dashboard.py and a UI-redesign preview instance can both be running at
# once against the same trading_state.db (see the "another engine
# instance" warning above), so Telegram notifications include this to
# make clear which one actually took the trade. Set via
